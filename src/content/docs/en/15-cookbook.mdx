...
Kiro will spin up subagents to run the three analyses simultaneously, then fan-in into a single report. Remember the parent agent needs `crew` trust set up first (see the Subagent chapter for details).
